...
def input_control(ang, rc):
	...
	rc[0].SpeedAccelDeccelPositionM1(0x80,10000,2000,10000, ang_m1, 1) # Enviar velocidad y posicion 
	...
	rc[0].SpeedAccelDeccelPositionM2(0x80,10000,2000,10000, ang_m2, 1) # Enviar velocidad y posicion
	...
	rc[1].SpeedAccelDeccelPositionM1(0x80,10000,2000,10000, ang_m3, 1) # Enviar velocidad y posicion 
	...
	rc[1].SpeedAccelDeccelPositionM2(0x80,10000,2000,10000, ang_m4, 1)   # Enviar velocidad y posicion 
	...
	rc[2].SpeedAccelDeccelPositionM1(0x80,10000,2000,10000, ang_m5, 1)  # Enviar velocidad y posicion 
	...
	rc[2].SpeedAccelDeccelPositionM2(0x80,10000,2000, 10000, ang_m6, 1)   # Enviar velocidad y posicion 
